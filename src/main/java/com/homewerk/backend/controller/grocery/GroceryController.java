...
public class GroceryController {
    ...
    @GetMapping("/search")
    public List<GroceryProduct> searchProducts(@RequestParam String query) {return groceryService.searchProducts(query);}
    ...
    @GetMapping("/prices")
    public GroceryPrice getPrice(@RequestParam String productId, @RequestParam String storeId) {return groceryService.getPrice(productId, storeId);}
